...
func_args: all_datatypes { task_array.push_back(","); func_array.push_back(std::string($1.converted)); task_array.push_back(std::string($1.converted)); method_array.push_back(std::string($1.converted));} IDENTIFIER {if(arr==0){func_array.push_back(std::string($3.ID)); method_array.push_back(std::string($3.ID)); task_array.push_back(std::string($3.ID));} else{func_array.push_back(std::string($3.ID)+"[]"); task_array.push_back(std::string($3.ID)+"[]"); method_array.push_back(std::string($3.ID)+"[]");}}
       ...
       | func_args COMMA {func_array.push_back(std::string($2.token)); task_array.push_back(std::string($2.token)); method_array.push_back(std::string($2.token)); } all_datatypes {func_array.push_back(std::string($4.converted));task_array.push_back(std::string($4.converted)); method_array.push_back(std::string($4.converted)); } IDENTIFIER {if(arr==0){func_array.push_back(std::string($6.ID));   task_array.push_back(std::string($6.ID));  method_array.push_back(std::string($6.ID)); } else{func_array.push_back(std::string($6.ID)+"[]");  task_array.push_back(std::string($6.ID)+"[]");  method_array.push_back(std::string($6.ID)+"[]"); }}
       {              
              // i_tb.addVariable($4.ID, $4.datatype, $4.is_atomic, $4.is_array);
...
func_scope: declaration
          ...
          | loop
          | return_routine return_statement
          | conditional
          | analyze_statement
          | input | output    | sleep
