...
func_args: all_datatypes {
              ...
              func_array.push_back(std::string($3.ID));  
              method_array.push_back(std::string($3.ID));
       ...
       | func_args COMMA {
              func_array.push_back(std::string($2.token)); 
              method_array.push_back(std::string($2.token));
              task_array.push_back(std::string($2.token));
       } all_datatypes {
              func_array.push_back(std::string($4.converted)); 
              method_array.push_back(std::string($4.converted)); 
              task_array.push_back(std::string($4.converted));       
       } IDENTIFIER {
              func_array.push_back(std::string($6.ID));  
              method_array.push_back(std::string($6.ID));      
              task_array.push_back(std::string($6.ID));
